...
from week14_homework.nets.yolo import YoloBody
from week14_homework.nets.yolo_training import (YOLOLoss, get_lr_scheduler, set_optimizer_lr,
                                                 weights_init)
from week14_homework.utils.callbacks import LossHistory
from week14_homework.utils.dataloader import YoloDataset, yolo_dataset_collate
from week14_homework.utils.utils import get_anchors, get_classes
from week14_homework.utils.utils_fit import fit_one_epoch
...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '../week13_homework/model_data/voc_classes.txt'
    #---------------------------------------------------------------------#
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '../week13_homework/2007_train.txt'
    val_annotation_path     = '../week13_homework/2007_val.txt'
